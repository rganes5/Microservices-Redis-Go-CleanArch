...
var file_pkg_proto_auth_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xe2, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
...
var file_pkg_proto_auth_proto_depIdxs = []int32{
	...
	2, // 3: pb.AuthService.GetUser:input_type -> pb.GetUserRequest
	5, // 4: pb.AuthService.Update:input_type -> pb.UpdateRequest
	7, // 5: pb.AuthService.Delete:input_type -> pb.DeleteRequest
	1, // 6: pb.AuthService.Register:output_type -> pb.RegisterResponse
	4, // 7: pb.AuthService.GetUser:output_type -> pb.GetUserResponse
	6, // 8: pb.AuthService.Update:output_type -> pb.UpdateResponse
	8, // 9: pb.AuthService.Delete:output_type -> pb.DeleteResponse
